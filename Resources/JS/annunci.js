...
.then((data)=>{//STEP 3 manipoliamo i dati ricavati
    ...
    let radioBrand = document.querySelector('#radioBrand');
    ...
    function filterByBrand(array){
        let arrayFromNodelist = Array.from(document.querySelectorAll('input[name="brands"]'));
    ...
    btnReset.addEventListener('click', ()=>{
        ...
        let radioBrands = document.querySelectorAll('input[name="brands"]');
